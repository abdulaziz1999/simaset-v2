        ...
        <div class="modal-body">
          <form class="form-horizontal" action="<?=base_url('lokasi/simpan')?>" autocomplete="off" method="post">
            <div class="form-group">
              <label for="kode_lokasi" class="col-sm-6 col-form-label">Kode Lokasi</label>
              <div class="col-sm-12">
                <input type="text" class="form-control" placeholder="Masukan Kode Lokasi.." name="kode_lokasi" required autofocus>
              </div>
            </div>
            <div class="form-group">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="<?=base_url('lokasi/ubah')?>" autocomplete="off" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="kode_lokasi" class="col-sm-6 col-form-label">Kode Lokasi</label>
              <div class="col-sm-12">
                <input type="text" class="form-control" value="<?=$lokasi_kode;?>" placeholder="Masukan Kode Lokasi.." name="kode_lokasi" required>
              </div>
            </div>
            <div class="form-group">
              <label for="nama_lokasi" class="col-sm-6 col-form-label">Nama Lokasi</label>
