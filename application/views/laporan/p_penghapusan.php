...
<html lang="en">
  <head>
    ...
    <title>Data Penghapusan Aset</title>
  </head>
  <body>
		...
		<div class="row">
  		...
  		<div class="row">
  			<div class="col text-left">
  				<p>Pada hari ini tanggal <?=tgl_indo(date('Y-m-d'));?> bertempat di <?=$lokasi['nama_lokasi']?> PT Astra International Tbk telah melaksanakan penghapusan aset berupa :</p>
  			</div>
  		</div>
  		<div class="row pt-3">
  			<div class="col">
