    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?php endif ?>
          <form class="form-horizontal" action="<?=base_url('update-inventory')?>" autocomplete="off" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?=$item['id'];?>">
            <div class="card-body">
                ...
                <div class="col-sm-6">
                  <select name="barang_id" class="form-control selectx" required>
                    ...
                    <?php foreach ($barang as $x): ?>
                      <option value="<?=$x['id_barang'];?>" <?=($x['id_barang'] == $item['barang_id'])? 'selected':'';?>><?=$x['kode_barang'];?> | <?=$x['nama_barang'];?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
                ...
                <div class="col-sm-6">
                  <select name="lokasi_id" class="form-control selectx" required>
                    ...
                    <?php foreach ($lokasi as $x): ?>
                      <option value="<?=$x['id_lokasi'];?>" <?=($x['id_lokasi'] == $item['lokasi_id'])? 'selected':'';?>><?=$x['kode_lokasi'];?> | <?=$x['nama_lokasi'];?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="number" name="tahun_anggaran" value="<?=$item['tahun_anggaran'];?>" placeholder="20XX" class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="pptk" class="col-sm-2 col-form-label">PPTK Pengadaan</label>
                <div class="col-sm-6">
                  <input type="text" name="pptk" value="<?=$item['pptk'];?>" placeholder="Masukan PPTK Pengadaan.." class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="no_bast" class="col-sm-2 col-form-label">No. Bast Pemegang</label>
                <div class="col-sm-6">
                  <input type="text" name="no_bast" value="<?=$item['no_bast'];?>" placeholder="Masukan No. Bast Pemegang.." class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="kir" class="col-sm-2 col-form-label">KIR</label>
                <div class="col-sm-6">
                  <input type="text" name="kir" value="<?=$item['kir'];?>" placeholder="Masukan KIR.." class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="tahun" class="col-sm-2 col-form-label">Tahun Anggaran</label>
                <div class="col-sm-6">
                  <input type="number" name="tahun" value="<?=$item['tahun'];?>" placeholder="20XX" class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <small>Kosongkan file jika tidak diisi</small>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" name="generate" id="generate" <?php if($item['qr_code'] != NULL){ echo 'checked="checked"'; } ?>>
