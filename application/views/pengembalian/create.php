  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" action="<?=base_url('store-pengembalian')?>" autocomplete="off" method="post">
            <div class="card-body">
              <div class="form-group row">
                <label for="pinjam_id" class="col-sm-2 col-form-label">Kode Peminjaman</label>
                <div class="col-sm-6">
                  <select name="pinjam_id" class="form-control selectx" required>
                    <option value="">Pilih..</option>
                    <?php foreach ($item as $x): ?>
                      <option value="<?=$x['id'];?>"><?=$x['kode_pinjam'];?></option>
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
